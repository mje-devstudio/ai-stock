...
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'data': [<br>        {<br>            'values': {<br>                '20': '110206',<br>                '10': '+60500',<br>                '11': '+200',<br>                '12': '+0.33',<br>                '15': '-7805',<br>                '13': '768293',<br>                '25': '2'<br>            },<br>            'type': '0H',<br>            'name': '주식예상체결',<br>            'item': '005930'<br>        }<br>    ],<br>    'trnm': 'REAL'<br>} |  |  |  |  |  |  |