...
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'trnm': 'REAL',<br>    'data': [<br>        {<br>            'type': '0C',<br>            'name': '주식우선호가',<br>            'item': '005930',<br>            'values': {<br>                '27': '-20800',<br>                '28': '-20700'<br>            }<br>        }<br>    ]<br>} |  |  |  |  |  |  |