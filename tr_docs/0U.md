...
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'data': [<br>        {<br>            'values': {<br>                '20': '111847',<br>                '666': '69.13',<br>                '1211': '0',<br>                '667': '1037.04',<br>                '668': '+44.73',<br>                '669': '+44.78'<br>            },<br>            'type': '0u',<br>            'name': 'ELW 지표',<br>            'item': '57JBHH'<br>        }<br>    ],<br>    'trnm': 'REAL'<br>} |  |  |  |  |  |  |