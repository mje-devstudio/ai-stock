...
|  | - item | 실시간 등록 요소 | String | N |  | 거래소별 종목코드<br>(KRX:039490,NXT:039490_NX,SOR:039490_AL) |
...
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'trnm': 'REAL',<br>    'data': [<br>        {<br>            'type': '0E',<br>            'name': '주식시간외호가',<br>            'item': '005930',<br>            'values': {<br>                '21': '165208',<br>                '131': '43955',<br>                '132': '+156',<br>                '135': '0',<br>                '136': '0'<br>            }<br>        }<br>    ]<br>} |  |  |  |  |  |  |